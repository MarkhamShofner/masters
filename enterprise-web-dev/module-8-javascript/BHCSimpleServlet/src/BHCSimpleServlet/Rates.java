...
public class Rates {
    ...
    /** Determine if the entered dates are valid; messages slightly altered by Jocelyn Munson for clarity.
     * 
     ...
     */
     public boolean isValidDates() {
        if (beginDate == null ||
                endDate == null) {
            details = "the begin date is either left blank or is completely invalid";
            return false;
        } else if (beginDate.getYear() != endDate.getYear()) {
                details = "the begin and end date of the hike must be within the same year";
                return false;
        } else if (beginDate.equals(endDate)) {
                details = "The begin and end date of the hike must not be the same date";
                return false;
            ...
            if (!beginDate.after(endDate)) {
                if ((!beginDate.before(seasonStartMonth, seasonStartDay)) &&
                    ...
                    details = "the begin or end date of the hike is out of season";
                    return false;
                }
            } else {
                details = "the end date is before begin date of the hike";
                return false;
            }
        } else {
            details = "the begin date entered is not a valid day";
            return false;
        }
   ...
   //     System.out.println("baseRate = " + baseRate + ", premiumRate = " + premiumRate + ", rate = " + rate);
    ...
    public static void main(String[] argv) {
        ...
        System.out.println("duration is " + (success ? "good" : "bad"));
